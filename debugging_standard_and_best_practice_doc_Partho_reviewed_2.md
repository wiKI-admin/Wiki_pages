# **Debugging standards and best practices**
...
![](Images/Picture1.png)PyCharm already comes with a debugger when you
download the program and the python version. In vs Code you need to
install the python extension as well:

!![](Images/Picture2.png)Then you can set a breakpoint at a line where you
want the debugger to pause the execution of the code:

![](Images/Picture3.png)And start the debugger:
...
### Preparing the DGB debugger for use 
